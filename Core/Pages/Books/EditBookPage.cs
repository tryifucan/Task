...
{
    public  class EditBookPage(IWebDriver driver, WebDriverWait wait) : BasePage(driver, wait)
    {
        ...
        public void EditBook(string name, string author, string genre, string quantity)
        {
            EnterName(name);
            EnterAuthor(author);
            EnterGenre(genre);
